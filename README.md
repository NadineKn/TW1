...
- Stockholm, Göteborg respektive Malmö står för störst intäkt.
...
1. Electronics, 2. Sports, 3. Clothing.
...
```bash
# klona projektet
git clone https://github.com/NadineKn/TW1.git
...
## Grupp 05 - Roller/ansvar

- **Bilal Mah:** 1. Vad säljer? – vilka kategorier driver mest intäkt?

- **Nadine Knoop:** 2. Var säljer vi? – vilka städer står för störst intäkt?

- **Isac Reger:** 3. När säljer vi? – finns tidsmönster/säsong i försäljningen?

- **Ida Claesson:** 4. Hur ser en typisk order ut? – AOV (Average Order Value) och spridning?

- **Marie Theorell:** 5. Topp-listor – topp-3 kategorier efter intäkt.

- **Henrik Andersson:** 6. Eventuella avvikelser – något oväntat mönster som sticker ut?
